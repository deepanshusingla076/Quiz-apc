...
CREATE TABLE achievements (
    ...
    requirement_type ENUM('QUIZ_COMPLETION', 'SCORE_THRESHOLD', 'STREAK', 'CATEGORY_MASTER', 'SPEED_DEMON') NOT NULL,
...
CREATE TABLE user_achievements (
    ...
    quiz_id BIGINT, -- if achievement was earned from specific quiz
...
INSERT INTO users (username, email, password, first_name, last_name, role, institution, bio, total_points) VALUES
('john_doe', 'john.doe@qwizz.com', '$2a$10$eUz1YrEeZgqQ8Qx8VrIkVeY.Lj3rQ4X5nKmL8pQrS6tUvWxYz0A1B2', 'John', 'Doe', 'TEACHER', 'Tech University', 'Senior Programming Instructor with 10+ years experience', 3200),
('jane_smith', 'jane.smith@qwizz.com', '$2a$10$eUz1YrEeZgqQ8Qx8VrIkVeY.Lj3rQ4X5nKmL8pQrS6tUvWxYz0A1B2', 'Jane', 'Smith', 'STUDENT', 'Tech University', 'Computer Science student passionate about learning', 1850),
('mike_wilson', 'mike.wilson@qwizz.com', '$2a$10$eUz1YrEeZgqQ8Qx8VrIkVeY.Lj3rQ4X5nKmL8pQrS6tUvWxYz0A1B2', 'Mike', 'Wilson', 'TEACHER', 'Science College', 'Mathematics and Physics educator', 2900),
('sarah_lee', 'sarah.lee@qwizz.com', '$2a$10$eUz1YrEeZgqQ8Qx8VrIkVeY.Lj3rQ4X5nKmL8pQrS6tUvWxYz0A1B2', 'Sarah', 'Lee', 'STUDENT', 'Tech University', 'Engineering student with focus on programming', 2100),
('alex_brown', 'alex.brown@qwizz.com', '$2a$10$eUz1YrEeZgqQ8Qx8VrIkVeY.Lj3rQ4X5nKmL8pQrS6tUvWxYz0A1B2', 'Alex', 'Brown', 'STUDENT', 'Science College', 'Mathematics enthusiast and problem solver', 1650);
...
('First Steps', 'Complete your first quiz', 'fa-baby', '#4CAF50', 'QUIZ_COMPLETION', 1, 50),
('Quiz Master', 'Complete 10 quizzes', 'fa-crown', '#FFD700', 'QUIZ_COMPLETION', 10, 200),
('Perfect Score', 'Achieve 100% on any quiz', 'fa-star', '#FF6B35', 'SCORE_THRESHOLD', 100, 150),
('Speed Demon', 'Complete a quiz in under 5 minutes', 'fa-rocket', '#00D2FF', 'SPEED_DEMON', 300, 100),
('Week Warrior', 'Maintain a 7-day quiz streak', 'fa-fire', '#FF3366', 'STREAK', 7, 300);
...
INSERT INTO user_achievements (user_id, achievement_id, quiz_id, earned_at) VALUES
(2, 1, 1, DATE_ADD(NOW(), INTERVAL -2 DAY)),
(2, 3, 1, DATE_ADD(NOW(), INTERVAL -2 DAY)),
(4, 1, 1, DATE_ADD(NOW(), INTERVAL -3 DAY)),
(4, 3, 4, DATE_ADD(NOW(), INTERVAL -1 DAY)),
(5, 1, 3, DATE_ADD(NOW(), INTERVAL -4 DAY));
